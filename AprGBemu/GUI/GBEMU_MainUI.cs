...
namespace AprGBemu
{
    public partial class AprGBemu_MainUI : Form
    {
        ...
        public void check_mod()
        {
            ...
            {
                case 4:
                    Console.WriteLine("32-Bits x86 mode");
                    break;
                case 8:
                    Console.WriteLine("64-Bits x64 mode");
                    break;
            }
        }
        ...
        public string ReadCartInfo()
        {
            if (gb_machine == null)
                return "";

            return gb_machine.Info;
        }
        ...
        public void Configure_Write()
        {
            ...
            if (gb_machine != null && gb_emu != null)
            {
                ...
                gb_machine.runtype = HardwareType.GameBoy;
                if (AppConfigure["HardwareType"] == "DMG")
                    gb_machine.runtype = HardwareType.GameBoy;
                else if (AppConfigure["HardwareType"] == "CGB")
                    gb_machine.runtype = HardwareType.GameBoyColor;
                else if (AppConfigure["HardwareType"] == "SGB")
                    gb_machine.runtype = HardwareType.SuperGameBoy;

                if (AppConfigure["BootStrap"] == "1")
                    gb_machine.run_bootstrap = true;
                else
        ...
        private void UI_OpenROM_select(object sender, EventArgs e)
        {
            ...
            fd.Filter = "GB & GBC ROM|*.gbc;*.gb;*.zip"; //"GameBoy ROM|*.sgb;*.gbc;*.gb"; not support all
        ...
        public void Clear()
        {
            UI_LCD_panel.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(224)))), ((int)(((byte)(224)))), ((int)(((byte)(224)))));
            UI_LCD_panel.Invalidate();
        }
